    ...
    async runQuery() {
      try {
        ...
        if (this.metric == "OBP") {
          ...
          response = await fetch(`https://www.baseballdatatrends.com/q4/obp?startYear=${this.year_range.min}&endYear=${this.year_range.max}`);
          ...
          response = await fetch(`https://www.baseballdatatrends.com/q4/rf?startYear=${this.year_range.min}&endYear=${this.year_range.max}`);
          ...
          response = await fetch(`https://www.baseballdatatrends.com/q4/obpa?startYear=${this.year_range.min}&endYear=${this.year_range.max}`);
